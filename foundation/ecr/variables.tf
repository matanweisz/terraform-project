...
variable "enable_cross_account_access" {
  description = "Enable cross-account access to repository"
  type        = bool
  default     = false
}

variable "allowed_account_ids" {
  description = "List of AWS account IDs allowed to pull images (only used if enable_cross_account_access is true)"
  type        = list(string)
  default     = []
}
